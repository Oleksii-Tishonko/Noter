        ...
        <div className="userAccountPage">
            ...
            <div className="selectorWindow">
                <div className="subPageList">
                    <Link to="?page=main" className="subpage">
                        Orders & Returns
                    </Link>
                    <Link to="?page=settings" className="subpage">
                        Settings
                    </Link>
                    <Link to="?page=payments" className="subpage">
                        Payments
                    </Link>
                    <Link to="?page=messages" className="subpage">
                        Messages
                    </Link>
                    <Link to="?page=customerservice" className="subpage">
                        Customer service
                    </Link>
                    <Link to="?page=data" className="subpage">
                        Data
                    </Link>
                </div>
